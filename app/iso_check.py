...
class ContainerValidator:
    ...
    def read_input(self, file_path=None):
        ...
        container_numbers = input("Enter container numbers separated by commas: ").split(',')
        return [number.strip() for number in container_numbers]

    def read_toml_file(self, file_path=SOC_FILE):
    ...
    def validate_soc_number(self, container_number):
        """Validate SOC number
    ...
    def validate_check_digit(self, container_number):
